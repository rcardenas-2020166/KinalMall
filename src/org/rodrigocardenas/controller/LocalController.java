...
public class LocalController implements Initializable
{
    ...
    @FXML private JFXButton btnCuentasPorCobrar;
    ...
    @FXML private FontAwesomeIconView iconCuentasPorCobrar;
    ...
    public void cargarDatos()
    {
        ...
        colDisponibilidad.setCellValueFactory(new PropertyValueFactory <Local, String>("disponibilidadTexto"));
...
//      colValorAdministracion.setCellValueFactory(new PropertyValueFactory <Local, Double>("valorAdministracion")); 
        colValorLocal.setCellValueFactory(new PropertyValueFactory <Local, String>("valorLocalTexto"));
        colValorAdministracion.setCellValueFactory(new PropertyValueFactory <Local, String>("valorAdministracionTexto")); 
    }
    ...
    public void nuevo()
    {
        switch (tipoDeOperacion)
        {
            ...
            case NINGUNO:
                ...
                btnCuentasPorCobrar.setText("");
                btnCuentasPorCobrar.setDisable(true);
                iconCuentasPorCobrar.setFill(Color.rgb(35,54,112));
            ...
            case GUARDAR:
                ...
                btnCuentasPorCobrar.setText("       Cuentas por \n" +
                                            "       Cobrar");
                btnCuentasPorCobrar.setDisable(false);
                iconCuentasPorCobrar.setFill(Color.rgb(243,156,18));
