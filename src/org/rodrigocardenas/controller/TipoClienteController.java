...
public class TipoClienteController implements Initializable
{
    ...
    @FXML private FontAwesomeIconView iconClientes;
    ...
    public void nuevo()
    {
        switch(tipoDeOperacion)
        {
            ...
            case NINGUNO:
                ...
                iconClientes.setFill(Color.rgb(35,54,112));
            ...
            case GUARDAR:
                ...
                iconClientes.setFill(Color.rgb(243,156,18));
    ...
    public void editar()
    {
        switch (tipoDeOperacion)
        {
            ...
            case ACTUALIZAR:
                ...
                iconEditar.setWrappingWidth(130);
