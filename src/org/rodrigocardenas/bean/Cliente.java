...
public class Cliente 
{
    ...
    public Cliente(int codigoCliente, String nombresCliente, String apellidosCliente, String telefonoCliente, 
                    String direccionCliente, String emailCliente, int codigoLocal, int codigoAdministracion, int codigoTipoCliente) 
    {
    ...
    {
        return getCodigoCliente() + " | " + getTelefonoCliente();
    }
